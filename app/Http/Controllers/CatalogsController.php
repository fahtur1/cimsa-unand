...
class catalogsController extends Controller
{
    ...
    public function index(Request $request, Builder $htmlBuilder)
    {
        //
        if($request->ajax()) {
            $catalogs = catalogs::select(['id','name','price','image','description','updated_at', 'available']);
            return Datatables::of($catalogs)
                ...
                ->editColumn('updated_at', function ($catalogs) {
                    return $catalogs->updated_at->format('d F Y');
                })
                ->toJson();
        }
    ...
    public function showCatalogDetail($id)
    {
        $catalog    = Catalogs::find($id);
        return view('catalogs-detail', compact('catalog'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $catalogs->available = $request->available;
        ...
        if ($request->hasFile('inputfreqd')) 
        {
            ...
            $destinationPath = getcwd(). DIRECTORY_SEPARATOR . 'images' . DIRECTORY_SEPARATOR . 'catalogs';
    ...
    public function update(Request $request, $id)
    {
        ...
        $catalogs->available = $request->editavailable;
