        ...
        <div class="row">
            <div class="col-md-9">
                <section class="main-article">
                    ...
                    <hr>
                    <img src="{{ url('images/articles').'/'.$articles->image }}"class="img-fluid img-thumbnail" alt="articles image" style="margin-bottom: 20px; width: 100%; height: auto;">
                    <br>
                    ...
                    <div class="row">
                        @foreach($recentpost as $index=>$article)
                            ...
                            <div class="col-md-6" style="margin-bottom: 30px;">
                                <a href="{{ route('articles.detail', $id[$index]) }}">
