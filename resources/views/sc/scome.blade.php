...
@section('content')
<header class="header">
    <div class="jumbotron jumbotron-fluid sco-background">
...
<section class="section-2 section-about container">
    <div class="image-about img-animated-section2" style="text-align: center;">
        <img src="/img/sco/scome.png" alt="CIMSA LOGO" style="width: 100%; height: auto;" class="img-responsive">
    </div>
    <br>
        ...
        <p class="text-justify">
            <div class="row">
                <div class="col-md-7 text-justify">
                    ...
                    education's system and also as forum for Indonesian medical student to develop their knowledges and skills in medical field. It is our vision to create
                    a qualified and competitive Medical Human Resources in order to have the ability to face every change in local and global scale. SCOME is committed to do
                    an active effort to support medical students in receiving a comprehensive medical education.
                </div>
                <div class="col-md-5">
                    <img class="img-fluid" style="object-fit: contain;" src="/img/sco/bg/scome.png" alt="">
                </div>
            </div>
            ...
            <span>MISSION</span><br>"We aim to achive excellence in medical education throughout the world."<br><br>
        </p>
    </div>
</section>
