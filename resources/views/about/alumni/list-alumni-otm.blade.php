        ...
        <div class="card-deck" style="margin-bottom: 20px;">
            ...
            @foreach($lotm as $index=>$activity)
                <div class="col-md-4">
                    ...
                    src="{{ url('images/lotm').'/'.$activity->image }}" alt="Card image cap">
                    <div class="card-body">
                        ...
                        <div class="card-text fr-view">{{ substr(strip_tags($activity->content),0,80).'...' }}
                            <a href="{{ route('lotm.detail', $id[$index]) }}">[ Read more ]</a>
                        </div>
                    </div>
                </div>
                </div>
            ...
            @else
                <div class="col-md-4">
                    ...
                    <div class="card-body">
                        <p class="card-text"><small class="text-muted">Posted : No Alumni Found</small></p>
