            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="{{ url('admin/list-alumni-otm') }}" class="{{ Request::is('admin/alumni/list-alumni-otm') ? 'active' : '' }}">List Alumni Of Period</a>
                        </li>
                ...
                <li>
                    <a href="{{ url('admin/message') }}"><i class="fa fa-comments fa-fw" aria-hidden="true"></i>Message Inbox</a>
                </li>
                <li>
                    <a href="{{ url('admin/resetaccount') }}" id="reset"><i class="fa fa-user fa-fw" aria-hidden="true"></i> Reset Account</a>
                </li>
                <li>
                    {!! Form::open(['url'=>'logout','method'=>'post','id'=>'form-logout']) !!}
                        
                    {!! Form::close() !!}
                    <a href='' id="logout"><i class="fa fa-sign-out fa-fw" aria-hidden="true"></i> Logout</a>
                </li>
            </ul>
        </div>
        <!-- /.sidebar-collapse -->
