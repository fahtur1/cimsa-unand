...
<div id="wrapper">
    <div id="page-wrapper" style="height: 100%;">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Senior of Period</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                ...
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        ...
                        data-toggle="modal" data-target=".post-modal">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add Senior of Period
                        </button>
                    </div>
                    <!-- /.panel-heading -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add Senior of Period</h4>
            </div>
            <div class="modal-body">
                {!! Form::open(['url'=> 'admin/store-lotm', 'method'=>'post', 'class'=>'clearfix','id'=>'form-modal','files' => 'true']) !!}
                    <div class="form-group">
                        {!! Form::text('title', null, ['class'=>'form-control','placeholder'=>'Title','id'=>'title','required'=>'true']) !!}
                    </div>
                    <div class="form-group">
                        <!-- {!! Form::text('month', null, ['class'=>'form-control','placeholder'=>'Choose Month','id'=>'month','required'=>'true']) !!} -->
                        <select class="tags form-control semester-multi" id='month' tabindex="-1"  name="month">
                    ...
                    <div class="form-group">
                        {!! Form::number('year', null, ['class'=>'form-control','placeholder'=>'Year','id'=>'year','required'=>'true']) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::text('name', null, ['class'=>'form-control','placeholder'=>'Alumni Name','id'=>'name','required'=>'true']) !!}
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Edit Senior of Period</h4>
            </div>
            <div class="modal-body">
                {!! Form::open(['url'=> 'admin/update-lotm', 'method'=>'put', 'class'=>'clearfix','id'=>'form-edit-modal','files' => 'true']) !!}
                    <div class="form-group">
                        {!! Form::text('edittitle', null, ['class'=>'form-control','placeholder'=>'Title','id'=>'edit-title','required'=>'true']) !!}
                    </div>
                    <div class="form-group">
                        <!-- {!! Form::text('editsubtitle', null, ['class'=>'form-control','placeholder'=>'Month-Year','id'=>'edit-subtitle','required'=>'true']) !!} -->
                        <select class="tags form-control semester-multi" id='edit-month' tabindex="-1"  name="editmonth">
                            <option value="" selected disabled hidden>Choose here</option>
                            <option value="January">January</option>
                            <option value="February">February</option>
                            <option value="March">March</option>
                    ...
                    <div class="form-group">
                        {!! Form::number('edityear', null, ['class'=>'form-control','placeholder'=>'Year','id'=>'edit-year','required'=>'true']) !!}
                    </div>

                    <div class="form-group">
                        {!! Form::text('editname', null, ['class'=>'form-control','placeholder'=>'Alumni Name','id'=>'edit-name','required'=>'true']) !!}
                    </div>
                    <div>
...
@section('script')
    ...
    <script>
        ...
        function geteditdata(self){
            ...
            var url = 'update-lotm/'+iditem
            self.setAttribute('class','fa fa-circle-o-notch fa-spin fa-lg')
            $.ajax({
                url:'/admin/alumni/edit-lotm/'+iditem,
                method:'GET'
            }).done(function(res){
                self.setAttribute('class','fa fa-pencil-square-o fa-lg')
                $('#edit-title').val(res.data.title)
                $('#edit-month').val(res.data.month)
                $('#edit-year').val(res.data.year)
                $('#edit-name').val(res.data.alumni_name)
